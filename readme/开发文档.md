...
### 1.1 项目背景
本项目基于ESP32-S3-CAM开发板，实现一个基础的网络视频监控系统。系统支持实时视频流传输和拍照功能，适用于家庭监控、安防监控等场景。
...
#### 5.2.2 视频流控制按钮
- **在新标签页中打开视频流**：在新标签页中打开视频流，提供更清晰的观看体验
...
```cpp
// WiFi配置
const char* ssid = "zhuline";         // WiFi名称
const char* password = "zhu8437547";  // WiFi密码
```
...
#define CAMERA_XCLK_FREQ 22000000     // 摄像头时钟频率：22MHz
