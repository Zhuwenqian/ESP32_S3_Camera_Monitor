...
1. **No Warranty**: This software is provided "as is", without any express or implied warranties. The authors and GLM-4.7 make no representations about the suitability of this software for any purpose.
...
The authors and GLM-4.7 are not liable for any damages arising from the use of this software.
...
1. **无保证**：本软件按"原样"提供，不提供任何明示或暗示的保证。作者和GLM-4.7不对本软件适用于任何目的作任何声明。
